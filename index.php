...
<title>NITK TEST PORTAL || HOMEPAGE</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo">Welcome to NITK TEST PORTAL</span></div>
...
<a href="http://nitk.ac.in" target="_blank">About us</a>
</div>
<div class="col-md-3 box">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/nitk1.png" width=100 height=100 alt="Nimish" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<h4 style="color:#202020; font-family:'typo' ; font-size:18px">Akshay Pandita</h4>
    </div>
    </div>
		</p>
      </div>
...
if (annyang) {
  ...
  var commands = {
    'feedback': function() {
      window.location.href="/Online/feedback.php";
    },
    'about': function(){
